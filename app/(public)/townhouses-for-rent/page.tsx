...
export const metadata: Metadata = {
  ...
  description:
    'Browse active MLS® townhouse and townhome rental listings across the Greater Toronto Area. Search freehold and condo townhouses for rent in Toronto, Mississauga, Vaughan, Markham, and all GTA cities.',
