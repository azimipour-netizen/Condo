    ...
    <div className="fixed bottom-6 right-4 z-50 flex flex-col gap-3">
      ...
      >
        <svg viewBox="0 0 24 24" fill="white" width="26" height="26">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.118.553 4.105 1.523 5.827L.057 23.882l6.198-1.626A11.933 11.933 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.793 9.793 0 01-5.001-1.373l-.358-.214-3.714.975.992-3.622-.233-.374A9.794 9.794 0 012.182 12C2.182 6.58 6.58 2.182 12 2.182S21.818 6.58 21.818 12 17.42 21.818 12 21.818z"/>
        </svg>
      </a>
